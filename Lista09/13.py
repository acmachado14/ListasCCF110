#13. Crie um algoritmo que leia uma matriz A[NxN] (N ≤ 10) e calcule a respectiva
#matriz transposta At. Exemplos de matrizes transpostas: (no pdf)

#matriz transposta é simplistmente onde linhas viram colunas e vice versa!!
